                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="whatwedo">
                                    ...
                                    <img src={require('../../assets/img/about/how-to-order/image.png')} class="img-fluid w-100" alt="" />
                                    <div class="quotes">
                                    ...
                                    <div class="list-group mt-4">
                                        <Link to={PATH.HOW_TO_USE_HGS} href="how-to-use-hgs.html" class="list-group-item list-group-item-action">
                                            How to use H.G.S.
                  </Link>
                                        <a href="payment.html" class="list-group-item list-group-item-action">Payment</a>
                                        <a href="faq.html" class="list-group-item list-group-item-action">FAQ</a>
                                        <a href="contact-staff.html" class="list-group-item list-group-item-action">Contact our staff</a>
                                    </div>
                                </div>
                            </div>
